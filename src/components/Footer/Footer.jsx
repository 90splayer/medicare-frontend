...
const socialLinks = [
  {
    path: "https://www.youtube.com/c/Kampxc",
    icon: <AiFillYoutube className='group-hover:text-white w-4 h-5'/>,
  },
  {
    path: "https://github.com/90splayer",
    icon: <AiFillGithub className='group-hover:text-white w-4 h-5'/>,
  },
  {
    path: "https://www.instagram.com/kampxc",
    icon: <AiOutlineInstagram className='group-hover:text-white w-4 h-5'/>,
  },
  {
    path: "https://www.linkedin.com/in/ojogbomichael",
  ...
  return (
    <footer className='pb-16 pt-10'>
      ...
      <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px]'>
        ...
        Copyright {year} developed by Michael Ojogbo all rights reserved.
        </p>
