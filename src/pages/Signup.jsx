    ...
    <section className='px-5 xl:px-0'>
      ...
      <div className='mb-5'>
        ...
        <div className='mb-5 flex items-center justify-between'>
          ...
          leading-7 '>
            Are you a:
            <select name='role' className='text-textcolor 
          ...
          leading-7 '>
            Gender:
            <select name='gender' className='text-textcolor 
            font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'
        ...
        <div className='mt-7'>
          <button type='submit' className='w-full bg-primaryColor
           text-white text-[18px] leading-[30px] rounded-lg px-4 py-3'>Sign Up</button>
        </div>
        <p className='mt-5 text-textColor text-center'>
        Already have an account?<Link className='text-primaryColor font-medium ml-1'
        to='/login'>Login</Link>
        </p>
      </form>
          </div>
